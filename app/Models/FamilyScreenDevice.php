...
class FamilyScreenDevice extends Model
{
    ...
    {
        static::creating(function (FamilyScreenDevice $device): void {
            if (! $device->token) {
    ...
    public static function createForFamily(Family $family, string $deviceName = ''): self
    {
