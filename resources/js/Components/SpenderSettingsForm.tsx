...
export default function SpenderSettingsForm({ spender, family: _family, pocketMoneySchedule }: Props) {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        put(route('spenders.update', spender.id), { preserveScroll: true });
    }
            ...
            <form onSubmit={submit}>
                <Card>
                    ...
                    <CardContent className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <Label htmlFor="spender-name">Name</Label>
                            <Input
                                id="spender-name"
                                value={data.name}
