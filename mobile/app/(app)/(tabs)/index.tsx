...
const styles = StyleSheet.create({
  ...
  content: { padding: 16 },
  greeting: { fontSize: 24, fontWeight: '700', color: colors.bark[700], marginBottom: 16 },
  ...
  statLabel: { fontSize: 12, color: colors.bark[600], marginBottom: 4 },
  statValue: { fontSize: 20, fontWeight: '700', color: colors.bark[700] },
  ...
  kidName: { fontSize: 16, fontWeight: '600', color: colors.bark[700] },
  kidBalance: { fontSize: 14, color: colors.bark[600], marginTop: 2 },
  section: { marginTop: 20 },
  sectionTitle: { fontSize: 18, fontWeight: '600', color: colors.bark[700], marginBottom: 12 },
  ...
  approvalChore: { fontSize: 15, fontWeight: '500', color: colors.bark[700] },
  ...
  // Child view
  childName: { fontSize: 20, fontWeight: '600', color: colors.white, textAlign: 'center', marginBottom: 8 },
  childBalance: { fontSize: 48, fontWeight: '700', color: colors.wattle[400], textAlign: 'center', marginBottom: 24 },
