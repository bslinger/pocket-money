...
const styles = StyleSheet.create({
  ...
  content: { padding: 16 },
  greeting: { fontFamily: fonts.display, fontSize: 24, fontWeight: '700', color: colors.bark[700], marginBottom: 16 },
  ...
  statValue: { fontFamily: fonts.display, fontSize: 20, fontWeight: '700', color: colors.bark[700] },
  ...
  avatarText: { fontFamily: fonts.body, color: colors.white, fontSize: 18, fontWeight: '600' },
  kidInfo: { marginLeft: 12, flex: 1 },
  kidName: { fontFamily: fonts.body, fontSize: 16, fontWeight: '600', color: colors.bark[700] },
  kidBalance: { fontFamily: fonts.body, fontSize: 14, color: colors.bark[600], marginTop: 2 },
  section: { marginTop: 20 },
  sectionTitle: { fontFamily: fonts.display, fontSize: 18, fontWeight: '600', color: colors.bark[700], marginBottom: 12 },
  ...
  approvalChore: { fontFamily: fonts.body, fontSize: 15, fontWeight: '500', color: colors.bark[700] },
  ...
  approveButtonText: { fontFamily: fonts.body, color: colors.white, fontWeight: '600', fontSize: 14 },
  // Skeleton
  ...
  // Child view
  childName: { fontFamily: fonts.body, fontSize: 20, fontWeight: '600', color: colors.white, textAlign: 'center', marginBottom: 8 },
  childBalance: { fontFamily: fonts.display, fontSize: 48, fontWeight: '700', color: colors.wattle[400], textAlign: 'center', marginBottom: 24 },
